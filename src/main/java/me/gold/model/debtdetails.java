...
public class debtdetails {
    ...
    public debtdetails(int id, String dept_id, String no_of_grams, String cash_paid, String card_paid, String date, String duedate,String employee_in_charge) {
        this.id = id;
    ...
    public debtdetails(String dept_id, String no_of_grams, String cash_paid, String card_paid, String date,String duedate,String employee_in_charge) {
        this.dept_id = dept_id;
        this.no_of_grams = no_of_grams;
        this.employee_in_charge=employee_in_charge;
        this.cash_paid = cash_paid;
