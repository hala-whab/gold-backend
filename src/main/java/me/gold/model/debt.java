...
public class debt {
    ...
    public debt(String customer_id, String customer_name, String weight, String dept_grams, String remaning, String gram_cash_price, String gram_card_price, String duedate, String date, String employee_in_charge) {
    ...
    public debt(int id, String customer_id, String customer_name, String weight, String dept_grams, String remaning, String gram_cash_price, String gram_card_price,String duedate, String date,String employee_in_charge) {
        this.id = id;
        this.customer_id = customer_id;
        this.customer_name = customer_name;
        this.employee_in_charge=employee_in_charge;
