...
public class Dpurchase {
    ...
    public Dpurchase(int id, String gram_Type, String details, String weight, String payment, String gram_cash_price, String gram_card_price, String no_Of_grams_Paid_cash, String no_Of_grams_Paid_card, String date, String employee_in_charge) {
        this.id = id;
    ...
    public Dpurchase(String gram_Type, String details, String weight, String payment, String gram_cash_price, String gram_card_price, String no_Of_grams_Paid_cash, String no_Of_grams_Paid_card, String date, String employee_in_charge) {
        this.Gram_Type = gram_Type;
        this.employee_in_charge=employee_in_charge;
        this.Details = details;
        this.weight = weight;
